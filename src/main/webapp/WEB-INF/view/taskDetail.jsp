...
<form id="input-form" action="${ctxp}/page/tasks/${it.bean.taskId}/update" class="form-horizontal" role="form">
  <input type="hidden" id="taskId" name="taskId" value="${it.bean.taskId}" />
