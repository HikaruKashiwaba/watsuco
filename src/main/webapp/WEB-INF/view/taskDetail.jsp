...
<form id="input-form" action="${ctxp}/page/tasks/1/update" class="form-horizontal" role="form">
  ...
  <div  class="form-group">
    <label for="title" class="control-labnel col-lg-2 col-md-2 col-sm-2 col-xs-2">内容</label>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
  ...
  <div  class="form-group">
    <label class="control-labnel col-lg-2 col-md-2 col-sm-2 col-xs-2">担当者</label>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
      佐藤
    </div>
  </div>
